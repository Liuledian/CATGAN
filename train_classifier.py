...
from utils.parser import get_omniglot_classifier_args,get_vgg_face_classifier_args
...
dagan_generator = torch.load(generator_path).cuda()
...
for real_batch_rate in (1, generated_batches_per_real + 1):
    ...
    for bootstrap_sample in range(num_bootstrap_samples):
        ...
        classifier = create_classifier(num_classes).cuda()

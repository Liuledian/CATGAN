...
def get_omniglot_dagan_args():
    ...
    parser.add_argument(
        ...
        default='/data_c/hsy/image_generation/datasets/npy/omniglot_data.npy'
    )
    parser.add_argument(
        "--final_model_path", type=str, help="Filepath to save final dagan model.",
        default='/data_c/hsy/image_generation/result/model_ckpt/g1.pth'
    )
    parser.add_argument(
        "--batch_size",
        nargs="?",
...
def get_vgg_face_dagan_args():
    ...
    parser.add_argument(
        ...
        help="Filepath for dataset on which to train dagan. File should be .npy format with shape "
        "(num_classes, samples_per_class, height, width, channels).",
        default='/data_c/hsy/image_generation/datasets/npy/vgg_face_data.npy'
    )
    parser.add_argument(
        "--final_model_path", type=str, help="Filepath to save final dagan model.",
        default='/data_c/hsy/image_generation/result/model_ckpt/g2.pth'
    )
    parser.add_argument(
        "--batch_size",
        nargs="?",
...
def get_vgg_face_classifier_args():
    parser = argparse.ArgumentParser(
        description="Use this script to train an omniglot classifier "
        "with and without augmentations to compare the results.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
